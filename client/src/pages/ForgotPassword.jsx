      ...
      <div className="card">
        ...
        {done ? (
          <>
            ...
            <p className="sub">{t("forgotPassword.checkEmailDesc")}</p>
          </>
        ) : (
          <>
            ...
            <form onSubmit={handleSubmit}>
              <div className="field">
                <label htmlFor="fp-email">{t("login.emailLabel")}</label>
              ...
              <button type="submit" className="submit" disabled={submitting}>
                <Send size={16} /> {submitting ? t("opForm.saving") : t("forgotPassword.sendLink")}
              </button>
            </form>
          </>
        )}
