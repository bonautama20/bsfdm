  ...
  return (
    <div ref={wrapperRef}>
      <style>{`
        ...
        .bsfdm .hero-card{position:absolute; top:50%; left:50%; transform:translate(-50%,-50%); width:230px; height:230px; border-radius:28px; background:var(--surface); box-shadow:var(--shadow-lg); display:flex; align-items:center; justify-content:center; z-index:3;}
        .bsfdm .hero-card .bug-img{width:auto; height:1050px; max-width:100%; object-fit:contain; display:block; filter:drop-shadow(0 8px 14px rgba(15,36,26,.18));}
        ...
        @media (max-width:520px){ .bsfdm .hero{padding-top:140px;} .bsfdm .hero-card{width:170px; height:170px;} .bsfdm .hero-card .bug-img{height:324px;} .bsfdm .hex-ring{width:250px; height:250px;} }
